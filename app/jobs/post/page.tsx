    ...
    return (
      <div className="max-w-lg mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-2">
          Your craving is now live on the board. Cooks will review it and express interest.
        </p>
  ...
  return (
    <div className="max-w-lg mx-auto px-6 py-10">
      ...
      <p className="text-gray-600 mb-8 text-sm">
        Describe what you need and cooks will express interest. You choose who to confirm.
      </p>
      <SessionBrief
        mode="job-board"
