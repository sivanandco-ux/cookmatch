        ...
        <section className="bg-panel rounded-sm border-l-4 border-copper-600 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-sm font-semibold text-green-700 uppercase tracking-wide mb-3">What we do</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex gap-2"><span className="text-green-600 mt-0.5">✓</span>List your profile, specialties, and availability so clients can find you — for sessions, specific items, or both</li>
                ...
                <li className="flex gap-2"><span className="text-green-600 mt-0.5">✓</span>Give you a private link to message clients directly — no account or login needed</li>
